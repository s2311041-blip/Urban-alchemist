export const TUTORIAL_SCENARIO = [
  {
    ...
    text: '市長、着任おめでとうございます。この街には、移動・効率性 (Link)・滞在・賑わい (Place)・安全・バリアフリー (Inclusive)・静穏・住環境 (Livability)——4つの願いが交差しています。',
  },
  {
    speaker: '副市長',
    role: 'システム',
